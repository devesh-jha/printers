                ...
                <form action="{{route('form.store')}}" method="POST" >
                    ...
                    <div class="mb-3">
                        ...
                        <select type="text" class="form-control" id="vendor"
                                placeholder="First name" name="vendor_id" required>
                    ...
                    <div class="mb-3">
                        ...
                        <select type="text" class="form-control" id="product"
                                placeholder="First name" name="product_id" required>
                    ...
                    <div class="mb-3">
                        <label>Sheets</label>
                        <div>
                            <input type="number" class="form-control" name="sheets" required
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <input type="number" class="form-control" name="rfbundle" required
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <input type="number" class="form-control" name="bundle" required
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <input type="text" class="form-control" name="amount_given" required
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <input type="text" class="form-control" name="wt_per_box" required
