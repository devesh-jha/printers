                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" placeholder="Enter Customer Name"
                                 name="name" value="{{$sale->name}}" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="number" placeholder="+91 1234567890"
                                id="example-text-input" name="contact" value="{{$sale->contact}}" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" placeholder="Enter Customer's GST No.'"
                                id="example-text-input" name="gstno" value="{{$sale->gstno}}" >
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" placeholder="Enter amount" id="example-text-input"
                                name="advancepay" value="{{$sale->advancepay}}" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="date" placeholder="Enter Customer Name"
                                id="example-text-input" name="date" value="{{$sale->date}}" required>
                        </div>
                    </div>
                    <div class="row mb-3">
